...
public class EventAdapter extends FirestoreRecyclerAdapter<Event, EventAdapter.ViewHolder>
{
    ...
    protected void onBindViewHolder(ViewHolder viewHolder, int position, Event event)
    {
        ...
        viewHolder.date.setText(DateFormatter.getStringFromTimestamp(event.getDate()));

        Picasso.get().load(imageUrl).placeholder(R.drawable.watering).error(R.drawable.watering).
